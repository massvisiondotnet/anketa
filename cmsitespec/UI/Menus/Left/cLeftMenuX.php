...
//require_once (PATH_CORE."Modules/Shop/cShop.php");

/**
 * Glavna izvrsna klasa
 * @brief Glavna izvrsna klasa
 */
class cLeftMenuX extends cMenuX
{
...
//      $this->mShopMngr = &$rObjectManager->getUnRegistredObject('cShopItemClassDataManager');
...
//         ,'table_active'         => true
   ...
   function createMenu()
   {
      $this->mMenu = new cVerticalMenuWithoutBorder($this->getMenuDefinition(), $this->getMenuItems());
   }
   ...
   function whoAmI()
   {
      return '_HOME/UI::Menus::Left::cLeftMenuX';
   }
